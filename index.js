...
app.get('/', (req, res) => {
	const meta = {
		title: 'Прием металлолома, пункт приема лома черных и цветных металлов в Москве, Одинцово и Одинцовском районе',
		description: 'Прием металлолома, пункт приема лома черных и цветных металлов в Москве, Одинцово и Одинцовском районе',
...
app.get('/about', (req, res) => {
	const meta = {
		title: 'Прием черного и цветного лома металла, сдать металлолом в Москве, Одинцово и Одинцовском районе дорого',
		description: 'ООО Стандарт осуществляет прием черного и цветного лома металла, у нас можно сдать машину, дверь и прочий металлолом в Москве, Одинцово и Одинцовском районе дорого.',
...
app.get('/price', (req, res) => {
	const meta = {
		title: 'Прием черного и цветного металлолома, цена за 1 кг в Москве, Одинцово и Одинцовском районе',
		description: 'У нас можно сдать черный и цветной металлолом дорого! Прием в Москве, Одинцово и Одинцовском районе цена за 1 кг — до 370 рублей!',
...
app.get('/services', (req, res) => {
	const meta = {
		title: 'Сдать металлолом с вывозом, демонтаж и вывоз металла в Москве, Одинцово и Одинцовском районе',
		description: 'У нас можно сдать металлом с вывозом! Сделаем все сами! Демонтаж, прием и вывоз черного и цветного металла в Москве, Одинцово и Одинцовском районе.',
		keywords: 'У нас можно сдать металлом с вывозом! Сделаем все сами! Демонтаж, прием и вывоз черного и цветного металла в Москве, Одинцово и Одинцовском районе.'
	}
