...
app.get('/', (req, res) => {
	const meta = {
		...
		description: 'Пункт приема металлолома в Одинцово осуществляет прием лома черных и цветных металлов в Одинцово по выгодным ценам',
		keywords: 'прием металлолома, прием цветных металлов, металлолом одинцово, пункт приема металла, пункт приема цветного металла, прием металла одинцово, пункт металлолома, пункт приема металлолома, прием металлолома в одинцово, прием лома одинцово, металлолом одинцово пункт приема'
	}
...
app.get('/about', (req, res) => {
	const meta = {
		title: 'Прием лома черных и цветных металлов, сдать металлолом в Одинцово, Москве, МО',
		description: 'ООО Стандарт осуществляет прием лома черного и цветного металла, у нас можно сдать металлолом в Одинцово дорого',
		keywords: 'прием черных металлов, прием лома металла, прием цветных металлов в одинцово, сдача металлолома, прием цветного лома, прием лома цветных металлов, сдать металлолом в одинцово, сдать металл одинцово, металл прием металлолома, прием черного лома'
	}
...
app.get('/price', (req, res) => {
	const meta = {
		...
		keywords: 'металлолом цена, прием цветных металлов цены, прием металлолома цена, металлолом цена за кг, сдать металлолом цена, прием металла одинцово цена, металлолом цена за 1, цена металлолома за 1 кг, металлолом цена одинцово, цветной металлолом цены, прайс приема металлолома'
	}
...
app.get('/services', (req, res) => {
	const meta = {
		...
		keywords: 'вывоз металлолома, вывоз металлолома одинцово, вывоз металла, сдать металлолом с вывозом, самовывоз металлолома, вывоз металлолома металла, метал прием вывоз, демонтаж металлолома, сдать металлолом с вывозом цена, вывоз черного металла, прием металлолома самовывоз'
	}
...
app.get('/contacts', (req, res) => {
	const meta = {
		...
		keywords: 'прием металлолома рядом со мной, прием металла карта, металлолом рядом, прием металлолома рядом, металлолом рядом со мной, металлолом телефон, металлолом на карте, прием металлолома на карте, номер телефона металлолома, прием металлолома рядом со мной, металлолом адрес'
	}
